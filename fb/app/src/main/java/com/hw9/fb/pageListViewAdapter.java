...
public class pageListViewAdapter extends ArrayAdapter<JSONObject> {
    favorite_manage favMan = null;
    public pageListViewAdapter(Context context, int resource, ArrayList<JSONObject> legislators) {
