...
public class favPlaceListViewAdapter extends ArrayAdapter<JSONObject> {
    favorite_manage favMan = null;
    public favPlaceListViewAdapter(Context context, int resource, ArrayList<JSONObject> legislators) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (user != null) {
            ...
            try {
                if(favMan.isFavorited("Places", user.getString("id"))){
