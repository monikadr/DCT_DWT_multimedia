...
public class eventViewDetails extends AppCompatActivity {
    ...
    eventAlbumDetailsAdaptor adaptor = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //share = fbshare.getInstance(getApplicationContext());
        ...
        adaptor = new eventAlbumDetailsAdaptor(getSupportFragmentManager(), tabLayout.getTabCount(),args);
