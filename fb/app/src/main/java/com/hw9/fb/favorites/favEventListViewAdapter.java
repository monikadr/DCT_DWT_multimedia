...
public class favEventListViewAdapter extends ArrayAdapter<JSONObject> {
    favorite_manage favMan = null;
    public favEventListViewAdapter(Context context, int resource, ArrayList<JSONObject> legislators) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            mViewHolder.details.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(getContext(), eventFavViewDetails.class);
        ...
        if (user != null) {
            ...
            try {
                if(favMan.isFavorited("Events", user.getString("id"))){
