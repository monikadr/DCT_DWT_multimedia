...
public class groupListViewAdapter extends ArrayAdapter<JSONObject> {
    favorite_manage favMan = null;
    public groupListViewAdapter(Context context, int resource, ArrayList<JSONObject> legislators) {
