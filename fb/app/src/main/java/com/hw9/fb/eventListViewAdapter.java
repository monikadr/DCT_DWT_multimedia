...
public class eventListViewAdapter extends ArrayAdapter<JSONObject> {
    favorite_manage favMan = null;
    public eventListViewAdapter(Context context, int resource, ArrayList<JSONObject> legislators) {
        ...
        if (convertView == null) {
            ...
            mViewHolder.details.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(getContext(), eventViewDetails.class);
