...
public class favUserListViewAdapter extends ArrayAdapter<JSONObject> {
    favorite_manage favMan = null;
    public favUserListViewAdapter(Context context, int resource, ArrayList<JSONObject> legislators) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (user != null) {
            ...
            try {
                if(favMan.isFavorited("Users", user.getString("id"))){
