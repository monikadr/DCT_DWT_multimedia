...
public class placeListViewAdapter extends ArrayAdapter<JSONObject> {
    favorite_manage favMan = null;
    public placeListViewAdapter(Context context, int resource, ArrayList<JSONObject> legislators) {
