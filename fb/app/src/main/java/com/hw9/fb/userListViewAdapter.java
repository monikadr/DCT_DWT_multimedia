...
public class userListViewAdapter extends ArrayAdapter<JSONObject> {
    favorite_manage favMan = null;
    public userListViewAdapter(Context context, int resource, ArrayList<JSONObject> legislators) {
