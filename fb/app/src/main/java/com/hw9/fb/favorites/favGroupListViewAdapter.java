...
public class favGroupListViewAdapter extends ArrayAdapter<JSONObject> {
    favorite_manage favMan = null;
    public favGroupListViewAdapter(Context context, int resource, ArrayList<JSONObject> legislators) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (user != null) {
            ...
            try {
                if(favMan.isFavorited("Groups", user.getString("id"))){
